...
THREE.Vector3.prototype.rotateY = function(t) {
    ...
    var i = this.z
      , s = this.x;
    this.x = s * cosRY + i * sinRY,
    this.z = s * -sinRY + i * cosRY
}
,
...
jQuery(document).ready(function($) {
    $("body").append('<div class="shopifytipsSnowEffect" style="position: fixed;z-index: 9999;left: 0;right: 0;bottom: 0;pointer-events: none;"></div>');
    var SCREEN_WIDTH = window.innerWidth, SCREEN_HEIGHT = window.innerHeight, container, particle, camera, scene, renderer, mouseX = 0, mouseY = 0, windowHalfX = window.innerWidth / 2, windowHalfY = window.innerHeight / 2, particles = [], particleImage = new Image;
    function snowEffectBind() {
        ...
        for (var e = new THREE.ParticleBasicMaterial({
    ...
    particleImage.src = "https://cdn.shopify.com/s/files/1/0382/4185/files/snow2.png?15818908823886250399",
    snowEffectBind();
});

$(function() {
    if (hura_show_effect || meta.page.pageType == 'password') {} else {
...
let toggle = document.querySelector('.slider');
  ...
  addEventListener('DOMContentLoaded', (e) => {
         setTimeout(() => {
            snowFall = document.querySelector('.shopifytipsSnowEffect');
            console.log(snowFall);
            toggle.addEventListener("click", function (e) {
            snowFall.classList.toggle('show__snow');
            }, 10);
         })
  });
